...
public record Term(boolean negate, Identity identity, Optional<Occurrence> occurrence) implements Nucleus, Fleck, IR {
    @Override
    public Text label() {
    ...
    public void prettyPrint(String indent) {
        ...
        if (!n.equals(qtf)) {
            ...
            System.out.printf("%s%s > %s > %s%n", indent, new String(label().raw()), new String(identity.label().raw()), new String(identity.raw()));
        }
    }
}
